 ...
 */
public class WPI_TalonSRXFactory {
    ...
    public static WPI_TalonSRX createPermanentSlaveTalon(int id, WPI_TalonSRX master) {
    ...
    public static WPI_TalonSRX createTalon(int id, Configuration config) {
        ...
        // TODO - these need to be updated for WPI_TalonSRX in CTRE Phoenix, they are for CANTalon
...
//        talon.setStatusFrameRateMs(CANTalon.StatusFrameRate.PulseWidth, config.PULSE_WIDTH_STATUS_FRAME_RATE_MS);
    ...
    public static String getFullTalonInfo(WPI_TalonSRX talon) {
    		StringBuilder sb = new StringBuilder("FIX ME");
...
//                .append(talon.getSensorCollection().isFwdLimitSwitchClosed()).append("\n").append("getFaultRevSoftLim = ")
//                .append(talon.getSensorCollection().isRevLimitSwitchClosed()).append("\n").append("getStickyFaultOverTemp = ")
////                .append(talon.getStickyFaults(sf.).append("\n")
