...
public class PathSegment {
    private static final double DEFAULT_PATH_FOLLOWING_MAX_ACCELERATION = Calibration.DEFAULT_PATH_FOLLOWING_MAX_ACCELERATION; //120.0;	// inches per second
     ...
     */
    public PathSegment(double x1, double y1, double x2, double y2, double maxSpeed, double maxAcceleration, MotionState startState,
            double endSpeed) {
        ...
        isLine = true;
        createMotionProfiler(startState, endSpeed, maxAcceleration);
    }

    public PathSegment(double x1, double y1, double x2, double y2, double maxSpeed, double maxAcceleration, MotionState startState,
            double endSpeed, String marker) {
    		this(x1, y1, x2, y2, maxSpeed, maxAcceleration, startState, endSpeed);
        this.marker = marker;
    }
    ...
    public PathSegment(double x1, double y1, double x2, double y2, double cx, double cy, double maxSpeed,
    			double maxAcceleration, MotionState startState, double endSpeed) {
        this.start = new Translation2d(x1, y1);
        this.end = new Translation2d(x2, y2);
    ...
    public PathSegment(double x1, double y1, double x2, double y2, double cx, double cy, double maxSpeed,
            double maxAcceleration, MotionState startState, double endSpeed, String marker) {
    		this(x1, y1, x2, y2, cx, cy, maxSpeed, maxAcceleration, startState, endSpeed);
        this.marker = marker;
    }
    ...
    public void createMotionProfiler(MotionState start_state, double end_speed, double pathFollowingMaxAccel) {
