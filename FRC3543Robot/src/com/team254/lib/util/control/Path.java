...
public class Path {
    ...
    public void checkSegmentDone(Translation2d robotPos) {
        ...
        if (remainingDist < PathConstants.kSegmentCompletionTolerance) {
    ...
    public void verifySpeeds() {
        ...
        for (int i = segments.size() - 1; i >= 0; i--) {
            ...
            maxStartSpeed += Math
                    .sqrt(maxStartSpeed * maxStartSpeed + 2 * PathConstants.kPathFollowingMaxAccel * segment.getLength());
        ...
        for (int i = 0; i < segments.size(); i++) {
            ...
            segment.createMotionProfiler(startState, endSpeed, PathConstants.kPathFollowingMaxAccel);
        }
    }
